  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        >
          <div className="absolute inset-0 bg-white/80 from-primary/95 to-primary/70" />
        </div>
        
        <div className="container relative z-10 mx-auto px-4 py-20 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-blue-800 mb-6 leading-tight animate-fade-in">
            Jasa Pembuatan Kaos Custom Berkualitas
          </h1>
          <p className="text-lg md:text-xl text-blue-800 mb-8 max-w-2xl mx-auto animate-fade-in">
